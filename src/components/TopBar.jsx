...
export function TopBar() {
    return <div className="flex justify-between p-3 gap-6 items-center h-12 bg-white border border-gray-200 fixed z-20 right-0 left-0 md:left-44">
        ...
        <div className="flex text-gray-700 gap-2">
            ...
            <div className="bg-gray-200 rounded-full w-7 h-7 flex items-center justify-center cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 3 20 20" fill="currentColor" className="w-4 h-4">
